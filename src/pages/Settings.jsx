...
export default function Settings() {
  ...
  return (
    <div className="min-h-screen bg-background px-8 py-12 max-w-xl mx-auto">
      ...
      <section className="mb-10">
        <h2 className="text-[11px] tracking-widest uppercase text-muted-foreground mb-4">Image Analysis</h2>
        <Link to="/admin/backfill" className="flex items-center justify-between border border-border/40 rounded-lg p-5 hover:bg-muted/30 transition-colors group">
          <span className="text-sm text-foreground">Backfill des images existantes</span>
