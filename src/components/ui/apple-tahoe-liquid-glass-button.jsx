    ...
    return (
      <>
        ...
        <button
          ...
          {...props}
        >
          <span className={`btn-liquid-lens-${filterId} absolute inset-0 rounded-[inherit] pointer-events-none`} style={{ zIndex: 0 }} />
          <span className={cn(`btn-liquid-text-${filterId} relative w-full flex items-center justify-center gap-[inherit] select-none`, contentClassName)} style={{ zIndex: 1, isolation: 'isolate' }}>
            {children}
          </span>
        </button>
      </>
